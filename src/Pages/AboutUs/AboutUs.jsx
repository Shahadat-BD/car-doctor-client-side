  ...
  return (
    <div className="lg:my-20 my-10">
      <div className="flex lg:flex-row flex-col justify-around gap-5">
        ...
        <img className=" lg:w-[400px] w-full h-[300px] lg:h-[350px] rounded-lg " src={about_1} alt=""  />
        <img className="lg:w-[240px] lg:h-[212px] w-44 h-40  border-8 border-white rounded-lg absolute lg:top-1/2 -bottom-16 left-20  lg:left-1/2 " src={about_2} alt="" />
        </div>
