        ...
        <div className='lg:w-[85%] m-auto w-[95%]'>
            <div className='mt-5 mb-20 relative'>
                ...
                <div className='absolute top-0 w-full h-full bg-gradient-to-l from-[#1010105f] to-[#101010b3]'>
                       <p className='flex justify-center items-center font-bold h-full text-white text-4xl'>Service Details</p>
            ...
            <div className='flex lg:flex-row flex-col gap-8'>
                <div className='w-3/4'>
                   ...
                   <div className='grid lg:grid-cols-2 grid-cols-1 gap-5 mb-20 mt-7'>
                   {
